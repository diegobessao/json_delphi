...
begin
  ...
  MessageDlg('Não existem registros para serem excluidos, verifique!', mtWarning, [mbOK], 0)
...
begin
  ...
  MessageDlg('Não é possível fazer uma busca com o campo do CNPJ vazio!', mtWarning, [mbOK], 0);
